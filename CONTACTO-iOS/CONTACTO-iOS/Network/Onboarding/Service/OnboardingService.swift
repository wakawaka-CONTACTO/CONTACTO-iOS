...
protocol OnboardingServiceProtocol {
    ...
    func emailSend(bodyDTO: EmailSendRequestBodyDTO, completion: @escaping (NetworkResult<Int>) -> Void)
...
final class OnboardingService: APIRequestLoader<OnboardingTarget>, OnboardingServiceProtocol {
    ...
    func emailSend(bodyDTO: EmailSendRequestBodyDTO, completion: @escaping (NetworkResult<Int>) -> Void) {
        fetchData(target: .emailSend(bodyDTO), responseData: Int.self, completion: completion)
    }
